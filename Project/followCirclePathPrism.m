function followCirclePathPrism()
filename = 'CirclePathPrism.gif';
RECORD = true;
frames = [];
f = figure(1);
...
% travel_path = WavyCirclePath(start_pt, linspace(0,2*pi, points), -0.5, @sin);
travel_path = SpiralPath([1,1,1], linspace(0,2*pi, points), 0.5, 0);
A.drawArm(ax);
i = 1;
i_old = 0;
i_frame = 0;
